...
//print_r($course_list['courses']);
//print_r($course_list['201']['name']);
?>
...
<section class="upcoming-section">
    ...
    <div class="card-row">
        <?php
        $num_courses = min(count($course_list['courses']), 3);
        ...
        ?>
            <div class="card">
                <div class="date-time">
                    ...
                    <h3><?= $course_list['courses'][$i]['time'] ?></h3>
                </div>

                <div class="circle"></div>

                <h2 class="course-name"><?= $course_list['courses'][$i]['name'] ?></h2>

                <p class="course-descriptionn"><?= $course_list['courses'][$i]['description'] ?></p>
            </div>
        <?php endfor; ?>
    </div>
</section>
